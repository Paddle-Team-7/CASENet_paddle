...
def main():
    ...
    #optimizer = torch.optim.SGD(policies, lr=args.lr,  =args.momentum, weight_decay=args.weight_decay)
    optimizer = paddle.optimizer.SGD(parameters=policies, learning_rate=args.lr, weight_decay=args.weight_decay)
